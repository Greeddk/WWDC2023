    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack(alignment: .center) {
                ...
                NavigationLink("Play the Portal Leather game!"){
                    CustomLadderView()
                }
            }
